...
logging.basicConfig(filename="logs/train_log.log", format='%(asctime)s: %(levelname)s: %(message)s')
...
x_text, y = deal_traindata.loadDataAndLabels(FLAGS.positive_data_file, FLAGS.negative_data_file)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # Generate batches
        batches = deal_traindata.batchIter(
